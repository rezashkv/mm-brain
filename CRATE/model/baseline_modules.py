...
import typing as ty
from .node import DenseBlock

from . import baseline_functional as rtdlF
...
class NODE(nn.Module):
    ...
    def forward(self, x_num: Tensor, x_cat: Tensor) -> Tensor:
        x_cat = x_cat.to(torch.int32) if x_cat is not None else None
        if x_cat is not None and x_cat.dim() > 2:
